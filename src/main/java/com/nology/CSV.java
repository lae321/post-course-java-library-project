...
public class CSV {
  ...
  public static Reader stripBom(InputStream in)
      throws java.io.IOException, java.io.UnsupportedEncodingException {
  ...
  private static boolean discardLinefeed(Reader in, boolean stripMultiple)
  ...
  private boolean skipComment(Reader in) throws java.io.IOException {
    ...
    while ((value = in.read()) != -1) {
      char c = (char) value;
      if (c == CRETURN) return discardLinefeed(in, stripMultipleNewlines);
    }
    return true;
  }
    ...
    while ((value = in.read()) != -1) {
      ...
      switch (c) {
        ...
        case LFEED:
          ...
          if (stripMultipleNewlines) return discardLinefeed(in, stripMultipleNewlines);
          else return false;
